...
var getIndicativePrice = {
  ...
  handler: async (runtime, message, state, options, callback) => {
    ...
    state = !state ? await runtime.composeState(message, { supportedChains }) : await runtime.updateRecentMessageState(state);
    ...
    try {
      ...
      const sellAmount2 = Number(price.sellAmount) / Math.pow(10, sellTokenMetadata.decimals);
