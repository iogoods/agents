...
describe('Email Integration', () => {
    ...
    describe('Basic Flow', () => {
        ...
        it('should handle multiple message sequences', async () => {
            ...
            service.shouldSendEmail = shouldSendEmailMock;
            service.handleEmailTrigger = vi.fn().mockResolvedValue(true);
            const messages = [
                'Hello there',
                'How are you?',
            ...
            const results = await Promise.all(messages.map(text => service.evaluateMessage({
                content: { text }
            })));
    ...
    describe('Error Handling', () => {
        ...
        it('should handle template rendering errors', async () => {
            ...
            service.handleEmailTrigger = vi.fn().mockRejectedValue(new Error('Template error'));
